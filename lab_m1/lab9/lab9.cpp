...
Texture2D* Lab9::CreateRandomTexture(unsigned int width, unsigned int height)
{
    ...
    // Mi se pare ca cel mai bine se vede cu MAG GL_NEAREST si MIN linear MIPMAP linear
    // Se vad diferente doar cand modific MAG din nearest in linear, dar in rest nu pot sa observ ceva semnificativ.
    // Nu inteleg de ce nu se observa ceva in rest.
